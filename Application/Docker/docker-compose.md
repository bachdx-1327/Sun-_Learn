...
Từ viết tắt **YAML** là viết tắt của _Yet Another Markup Language_. Nhưng những người bảo trì đã đổi tên nó thành _YAML Ain't Markup Language_ để nhấn mạnh hơn vào các tính năng hướng dữ liệu của nó.
